      ...
      <div className="lg:col-span-7 relative flex-col justify-between p-8 lg:p-12 bg-secondary/30 border-r border-border hidden lg:flex min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none select-none -z-5 overflow-hidden">
          ...
          <div className="absolute bottom-6 left-6 font-mono text-[9px] text-muted-text/25 tracking-widest">
            MODEL_INDEX_RENDER: {currentIdx + 1} / {GALLERY_IMAGES.length}
          </div>
        ...
        <div className="relative w-full max-w-xl mx-auto my-auto py-12 flex flex-col items-center">
          ...
          <motion.div
            ...
            className="relative w-80 h-80 sm:w-96 sm:h-96 rounded-none border border-border/40 overflow-hidden premium-shadow-lg bg-card cursor-grab select-none z-20"
          >
            <AnimatePresence mode="wait">
              ...
              >
                <img
                  src={GALLERY_IMAGES[currentIdx].url}
                  alt={GALLERY_IMAGES[currentIdx].title}
          ...
          >
            <motion.div
              ...
              className="bg-card/90 backdrop-blur-md border border-border p-3.5 rounded-2xl premium-shadow flex items-center gap-3 w-48 cursor-grab select-none"
            >
              <div className="w-10 h-10 rounded-lg overflow-hidden flex-shrink-0 bg-secondary pointer-events-none">
                <img
                  src="https://images.unsplash.com/photo-1594787318286-3d835c1d207f?w=100&auto=format&fit=crop&q=80"
                  alt="Miniature"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="min-w-0 pointer-events-none">
                <p className="text-[10px] font-bold text-primary tracking-wider uppercase">Custom Print</p>
                <p className="text-xs font-semibold text-primary-text truncate">High-Detail Mini</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <motion.div
              ...
              dragTransition={{ bounceStiffness: 450, bounceDamping: 15 }}
              whileDrag={{ scale: 1.08, cursor: 'grabbing' }}
              className="bg-card/90 backdrop-blur-md border border-border p-3.5 rounded-none premium-shadow flex items-center gap-3 w-48 cursor-grab select-none"
            >
              <div className="w-10 h-10 rounded-none overflow-hidden flex-shrink-0 bg-secondary pointer-events-none">
                <img
                  src="https://images.unsplash.com/photo-1607604276583-eef5d076aa5f?w=100&auto=format&fit=crop&q=80"
                  alt="Oni Figure"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="min-w-0 pointer-events-none">
                <p className="text-[10px] font-bold text-primary tracking-wider uppercase">Figurine</p>
                <p className="text-xs font-semibold text-primary-text truncate">Premium Collectible</p>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="space-y-6 z-20 max-w-2xl mx-auto w-full">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 pt-6 border-t border-border">
            <div className="flex flex-col items-center lg:items-start">
              ...
              <span className="text-[10px] text-muted-text mt-0.5">★★★★★ Rating</span>
            </div>
            <div className="flex flex-col items-center lg:items-start">
              <span className="font-bold text-primary-text text-sm">500+</span>
              <span className="text-[10px] text-muted-text mt-0.5">Orders Delivered</span>
            </div>
            <div className="flex flex-col items-center lg:items-start">
              <span className="font-bold text-primary-text text-sm">100+</span>
